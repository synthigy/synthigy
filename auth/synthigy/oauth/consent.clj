(ns synthigy.oauth.consent
  (:require
   ...
   [synthigy.dataset.sql.compose :as compose]))
...
(defmethod compose/prepare [::create-consent-table synthigy.Postgres]
  [_]
  (let [ddl (compose/mlf
...
(defmethod compose/prepare [::delete-consent-table synthigy.Postgres]
  [_]
  ["drop table __oidc_user_consent"])

(defmethod compose/prepare [::exists? synthigy.Postgres]
  [_]
...
(defmethod compose/prepare [::provide-consent synthigy.Postgres]
