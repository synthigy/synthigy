...
(def login-page-path
  "Filesystem directory served as the fallback custom login surface at /login/*.
  When set, /oauth/authorize redirects unauthenticated users here unless a
  per-client login-page setting overrides it."
  (env :synthigy-login-page-path))
