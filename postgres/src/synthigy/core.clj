(ns synthigy.core
  ...
  (:require
    ...
    ;; :synthigy/subscriptions.postgres at load time. NOT auto-started —
    ;; opt-in by `(lifecycle/start! :synthigy/subscriptions.postgres)`.
